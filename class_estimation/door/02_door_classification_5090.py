...
LOG_PATH = setup_logging("02_door_classification_5090")
...
MODEL_SAVE_PATH = os.path.join(ARTIFACTS_DIR, "best_door_model_5090.pth")
ONNX_SAVE_PATH = os.path.join(ARTIFACTS_DIR, "best_door_model_5090.onnx")
