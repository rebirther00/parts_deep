...
# 명령줄 인자 파싱
# ================================================================================
parser = argparse.ArgumentParser(description='굴착기 도어 분류 모델 평가 - CAD 합성 데이터 (RTX 5090)')
...
LOG_PATH = setup_logging("03_door_cad_evaluation_5090")
...
# ================================================================================
print("=" * 80)
print("굴착기 도어 분류 모델 평가 - CAD 합성 데이터 (RTX 5090 버전)")
print("=" * 80)
step1_start_time = time.time()


def scan_dataset_for_eval(dataset_dir, class_names):
    """dataset_dir에서 rgb_*.png를 스캔하여 평가 경로 리스트 생성 (빈 클래스 스킵)"""
    all_paths = []
    for class_name in class_names:
        ...
        if len(pngs) == 0:
            ...
            continue
        print(f"  [로드] {class_name}: {len(pngs)}장")
