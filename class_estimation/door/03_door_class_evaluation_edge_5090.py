"""
굴착기 도어 분류 모델 평가 스크립트 (Edge-only 버전)
- 02_door_classification_edge_5090.py에서 학습한 Edge 모델 평가
...
LOG_PATH = setup_logging("03_door_evaluation_edge_5090")
...
RESULTS_JSON_PATH = os.path.join(ARTIFACTS_DIR, "evaluation_results_door_edge_5090.json")
...
# ================================================================================
print("=" * 80)
print("굴착기 도어 분류 모델 평가 (Edge-only 버전)")
print("=" * 80)
...
if not os.path.exists(TRAIN_INDICES_PATH):
    raise FileNotFoundError(
        ...
        f"먼저 02_door_classification_edge_5090.py를 실행하세요."
    )
