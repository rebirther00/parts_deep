"""
굴착기 도어 분류 모델 평가 스크립트 (RGBE 버전)
- 02_door_classification_rgbe_5090.py에서 학습한 RGBE 모델 평가
...
LOG_PATH = setup_logging("03_door_evaluation_rgbe_5090")
