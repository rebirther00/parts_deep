...
- 취득: 시작 후 **2초 워밍업**(노출 안정화, 저장 안 함) → **2초에 1장** rgb/depth 쌍 저장 → **60초 후 자동 종료**. **[취득 종료]** 버튼으로 언제든 직접 종료 가능.
...
3. 1분 후 자동 종료됨. 더 일찍 끝내려면 **[취득 종료]** 버튼 (종료되면 도어 종류가 [모름/기타]로 돌아감). 다음 도어부터 2번 반복
