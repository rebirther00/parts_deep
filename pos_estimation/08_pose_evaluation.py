#!/usr/bin/env python3
# ==========================================
# Depth 기반 6DoF Pose Estimation 평가 스크립트
# ==========================================
#
# 학습된 모델을 사용하여 위치 및 자세 추정 정확도를 평가합니다.
#
# 사용법:
#   python 08_pose_evaluation.py
#   python 08_pose_evaluation.py --num_samples 100
#   python 08_pose_evaluation.py --bbox_crop
#   python 08_pose_evaluation.py --save_results
#
# ==========================================
...
def evaluate(args, model_path=None):
    ...
    print("=" * 80)
    print("📊 6DoF Pose Estimation 모델 평가")
    print("=" * 80)
    ...
    if args.save_results:
        ...
        if args.save_detailed:
            detailed_path = os.path.join(ARTIFACTS_DIR, "evaluation_detailed_results.json")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="6DoF Pose Estimation 모델 평가")
    parser.add_argument('--model', type=str, default='depth_gt_pose_best.pt',
                        help='모델 파일명 (기본: depth_gt_pose_best.pt)')
