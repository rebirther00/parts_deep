#!/usr/bin/env python3
# ==========================================
# Depth 기반 6DoF Pose Estimation V2 평가 스크립트
...
#
# 사용법:
#   python 13_pose_evaluation_v2.py
#   python 13_pose_evaluation_v2.py --num_samples 100
#   python 13_pose_evaluation_v2.py --save_results --verbose
#
# ==========================================
...
MODEL_PATH = os.path.join(ARTIFACTS_DIR, "depth_gt_pose_v2_best.pt")
RESULTS_PATH = os.path.join(ARTIFACTS_DIR, "evaluation_results_v2.json")
...
# ==========================================
# V2 모델: EfficientNetV2-S + Depth → 6DoF Pose
# ==========================================
...
def evaluate(args, model_path=None):
    ...
    print("=" * 80)
    print("📊 V2 6DoF Pose Estimation 모델 평가")
    ...
    if not os.path.exists(model_path):
        ...
        print("   먼저 학습을 실행하세요: python 09_depth_based_pose_v2.py --mode train")
        sys.exit(1)
    ...
    model_version = checkpoint.get('model_version', 'V2_EfficientNetV2S')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="V2 6DoF Pose Estimation 모델 평가 (EfficientNetV2-S)")
    parser.add_argument('--model', type=str, default='depth_gt_pose_v2_best.pt',
                        help='모델 파일명 (기본: depth_gt_pose_v2_best.pt)')
